...
To update the database use this command from the Web project folder (replace `VarobobaBackend` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../VarobobaBackend.Infrastructure/VarobobaBackend.Infrastructure.csproj -s VarobobaBackend.Web.csproj
```
